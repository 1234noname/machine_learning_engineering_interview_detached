variable "project_id" {
  description = "GCP project ID for the dev environment. Supply via terraform.tfvars or TF_VAR_project_id."
  type        = string
}
...
variable "enable_gpu_pool" {
  description = "When true, creates the GPU node pool in the cluster module. dev: false."
  type        = bool
  default     = false
}
